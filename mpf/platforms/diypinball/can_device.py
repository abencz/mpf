...
class _NullDevice(object):
    def __init__(self, interface=None):
        ...
        self.log.error('CAN not supported on current platform, using NULL CAN device')

    def send(self, commmand, flags):
        pass
...
class _SocketcanDevice(object):
    ...
    def send(self, command, flags=None):
...
CANDevice = _SocketcanDevice if 'PF_CAN' in dir(socket) else _NullDevice
